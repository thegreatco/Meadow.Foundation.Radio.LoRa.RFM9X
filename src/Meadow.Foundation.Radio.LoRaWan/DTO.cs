...
namespace Meadow.Foundation.Radio.LoRaWan
{
    internal record struct JoinRequest(byte[] JoinEui, byte[] DevEui, byte[] AppKey, ushort DevNonce)
    {
        public readonly RentedArray<byte> ToMessage()
        {
            ...
            joinRequestMessage.Array[0] = 0x00; // MHDR join should be 0x00
            ...
            var computedMic = AesCMac.ComputeAesCMac(AppKey, joinRequestMessage.Array[..19]);
